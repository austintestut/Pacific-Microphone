...
//app.get('/.well-known/acme-challenge/I5ucuFu-2bG6_8NFoxSTg9BXB4rEjezjN7D7Wb1m2dI', (req, res) => {
//  res.send('I5ucuFu-2bG6_8NFoxSTg9BXB4rEjezjN7D7Wb1m2dI.g2V9bo7R_cewtmHT3K8cZCPCyuC3twitQn6H-PIgT7E')
//})

https.createServer({
  key: fs.readFileSync('/home/ubuntu/secrets/privkey.pem'),
  cert: fs.readFileSync('/home/ubuntu/secrets/fullchain.pem')
}, app)
  .listen(port, () => {
